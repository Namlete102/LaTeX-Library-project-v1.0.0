...
Nhấn phím **Enter** được nhập trên bàn phím hai lần, để làm văn bản được được xuống dòng khi soạn thảo LaTeX. 
...
\documentclass{article}
\begin{document}
$$\log_b{xy} = \log_b{x} + \log_b{y}$$ % Sử dụng cặp dấu $$ để viết phương trình toán học
\end{document}
```
...
<div>
<img src="LaTeX-Library-project-v1.0.0/images/John Napier.jpg" alt="John Napier">
...
<div align="center">
<img src="LaTeX-Library-project-v1.0.0/images/Abraham de Moivre.jpg" alt="Moivre">
...
<img src="LaTeX-Library-project-v1.0.0/images/Albert Einstein.jpg" alt="Einstein">
